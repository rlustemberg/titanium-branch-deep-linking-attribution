...
{
    NSLog(@"www setUseTestBranchKey in library - tracking flag");
    NSLog(useTestBranchKey ? @"Yes" : @"No");
...
- (BOOL)setTrackingDisabled:(NSNumber *)disabled
{
    ...
    NSLog(@"www Inside setTrackingDisabled - trackingDisabled? - %d" , [Branch trackingDisabled]);
    return [Branch trackingDisabled];
}

#pragma mark - get user tracking value

- (BOOL)trackingDisabled:(id)args
{
    
    NSLog(@"www Inside trackingDisabled - trackingDisabled? - %d" , [Branch trackingDisabled]);
