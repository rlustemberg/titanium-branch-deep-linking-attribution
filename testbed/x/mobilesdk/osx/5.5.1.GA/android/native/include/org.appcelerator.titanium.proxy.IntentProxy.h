...
private:
	...
	static v8::Handle<v8::Value> getPackageName(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getClassName(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_className(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	...
	static v8::Handle<v8::Value> getter_packageName(v8::Local<v8::String> property, const v8::AccessorInfo& info);
