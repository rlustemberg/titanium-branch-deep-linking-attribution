...
private:
	...
	static v8::Handle<v8::Value> replaceAt(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> insertAt(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> hideKeyboard(const v8::Arguments&);
