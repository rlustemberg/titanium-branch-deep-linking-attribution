...
private:
	...
	static v8::Handle<v8::Value> addSharedElement(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> removeAllSharedElements(const v8::Arguments&);
	static v8::Handle<v8::Value> setOrientationModes(const v8::Arguments&);
	static v8::Handle<v8::Value> _getWindowActivityProxy(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_orientationModes(v8::Local<v8::String> property, const v8::AccessorInfo& info);
