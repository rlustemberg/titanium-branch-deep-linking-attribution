...
private:
	...
	static v8::Handle<v8::Value> requestPermissions(const v8::Arguments&);
	static v8::Handle<v8::Value> createBroadcastIntent(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> hasPermission(const v8::Arguments&);
