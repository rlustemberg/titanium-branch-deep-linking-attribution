...
private:
	...
	static v8::Handle<v8::Value> setCategory(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> setVisibility(const v8::Arguments&);
	static v8::Handle<v8::Value> setNumber(const v8::Arguments&);
	static v8::Handle<v8::Value> setStyle(const v8::Arguments&);
	static v8::Handle<v8::Value> setPriority(const v8::Arguments&);
	static v8::Handle<v8::Value> setIcon(const v8::Arguments&);
	static v8::Handle<v8::Value> setLargeIcon(const v8::Arguments&);
	...
	static void setter_visibility(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	...
	static void setter_largeIcon(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	...
	static void setter_category(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	static void setter_tickerText(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	static void setter_style(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	static void setter_ledARGB(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	static void setter_priority(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
