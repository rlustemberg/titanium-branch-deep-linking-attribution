...
private:
	...
	static v8::Handle<v8::Value> _restart(const v8::Arguments&);
	static v8::Handle<v8::Value> setProximityDetection(const v8::Arguments&);
	static v8::Handle<v8::Value> fireSystemEvent(const v8::Arguments&);
	static v8::Handle<v8::Value> getProximityState(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getProximityDetection(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_proximityDetection(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_proximityDetection(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	...
	static v8::Handle<v8::Value> getter_proximityState(v8::Local<v8::String> property, const v8::AccessorInfo& info);
