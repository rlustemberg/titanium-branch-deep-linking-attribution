...
private:
	...
	static v8::Handle<v8::Value> getLastGeolocation(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> requestLocationPermissions(const v8::Arguments&);
	static v8::Handle<v8::Value> getCurrentPosition(const v8::Arguments&);
	static v8::Handle<v8::Value> hasLocationPermissions(const v8::Arguments&);

	// Dynamic property accessors ----------------------------------------
	static v8::Handle<v8::Value> getter_locationServicesEnabled(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static v8::Handle<v8::Value> getter_lastGeolocation(v8::Local<v8::String> property, const v8::AccessorInfo& info);
