...
private:
	...
	static v8::Handle<v8::Value> getLongitudeDelta(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getLatitudeDelta(const v8::Arguments&);
	static v8::Handle<v8::Value> addAnnotation(const v8::Arguments&);

	// Dynamic property accessors ----------------------------------------
	static v8::Handle<v8::Value> getter_latitudeDelta(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static v8::Handle<v8::Value> getter_longitudeDelta(v8::Local<v8::String> property, const v8::AccessorInfo& info);
