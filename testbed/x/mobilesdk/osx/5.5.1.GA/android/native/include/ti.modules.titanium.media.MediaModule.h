...
private:
	...
	static v8::Handle<v8::Value> requestCameraPermissions(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> stopVideoCapture(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> startVideoCapture(const v8::Arguments&);
	static v8::Handle<v8::Value> hasCameraPermissions(const v8::Arguments&);
