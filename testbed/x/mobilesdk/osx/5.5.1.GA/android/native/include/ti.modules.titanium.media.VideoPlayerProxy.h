...
private:
	...
	static v8::Handle<v8::Value> requestThumbnailImagesAtTimes(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> cancelAllThumbnailImageRequests(const v8::Arguments&);
