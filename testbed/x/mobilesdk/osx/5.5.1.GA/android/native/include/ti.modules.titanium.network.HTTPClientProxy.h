...
private:
	...
	static v8::Handle<v8::Value> getTlsVersion(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> setTlsVersion(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_tlsVersion(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_tlsVersion(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
