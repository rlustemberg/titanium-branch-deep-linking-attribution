...
private:
	...
	static v8::Handle<v8::Value> getTintColor(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> setTintColor(const v8::Arguments&);

	// Dynamic property accessors ----------------------------------------
	static v8::Handle<v8::Value> getter_paused(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static v8::Handle<v8::Value> getter_tintColor(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_tintColor(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
